...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4 rounded-0 bg-black text-white" style="width: 728px height: 645px;">
...
devient une étape vers votre meilleure version!</p></blockquote></div>
        ...
        <div class="card mb-4 rounded-0 bg-black text-white" style="width: 573px; height: 446px;">
    <div class="card-body d-flex flex-column">
        <h4 class="card-title">HAUT DU CORPS</h4>
        <a href="#" class="btn btn-primary mt-auto align-self-end">See Profile</a>
